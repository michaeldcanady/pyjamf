...
from pyjamf.builder._advanced_mobile_device_searches_choices_request_builder import AdvancedMobileDeviceSearchesChoicesRequestBuilder
from pyjamf.builder._advanced_mobile_device_searches_delete_multiple_request_builder import AdvancedMobileDeviceSearchesDeleteMultipleRequestBuilder

from pyjamf.request import AdvancedMobileDeviceSearchesEntryRequest, AdvancedMobileDeviceSearchesEntryCollectionRequest
