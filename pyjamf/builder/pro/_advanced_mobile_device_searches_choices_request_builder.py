...
class AdvancedMobileDeviceSearchesChoicesRequestBuilder(EntityRequestBuilder):
    ...
    def request_with_options(self, options: Optional[Iterable[Union[QueryOption, HeaderOption]]]) -> AdvancedMobileDeviceSearchesChoicesEntryCollectionRequest:
        
        return AdvancedMobileDeviceSearchesChoicesEntryCollectionRequest(self.request_url, self.request_client, options)